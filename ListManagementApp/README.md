...
* Screenshot of movies added to list below:<br/><br/>
  <img src="./assets/images/movielist.jpg" width="250" />

#### 3. Error Handling
* Appropriate error handling done to show error message if user tries to add movie without entering movie name. 
* Screenshot of error below:<br/><br/>
  <img src="./assets/images/error.jpg" width="250" />

#### 4. Additional Feature:
* Clear button allows user to clear all movies in the list and start again.
* Screenshot of clear list below: <br/><br/>
  <img src="./assets/images/clear.jpg" width="250" />
